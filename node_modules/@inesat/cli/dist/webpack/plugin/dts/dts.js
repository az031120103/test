...
class DTSEmitFile {
    ...
    setup({ build, mf }) {
        this.build = build;
        this.mf = mf;
        const outDir = path_1.default.resolve(store_1.default.root, build.typesOutDir);
    ...
    emit(filename) {
        ...
        try {
            ...
            logger_1.default.warn('[inesatCli dts]', filename, e);
        }
    }
    createFile() {
        var _a;
        ...
        if (this.build.lib) {
            const libModName = this.build.lib.name || store_1.default.pkg.name;
            let libCode = this.lib.code;
            libCode = (0, transform_1.transformLibName)(libModName, libCode);
            this.libFilename = path_1.default.resolve(this.outDir, `${this.build.typesLibName}.d.ts`);
            fs_extra_1.default.writeFileSync(this.libFilename, libCode, 'utf8');
        }
        if ((_a = this.mf) === null || _a === void 0 ? void 0 : _a.exposes) {
            const inesatCliModName = this.mf.name || '';
            let inesatCliCode = this.lib.code;
            inesatCliCode = (0, transform_1.transformLibName)(inesatCliModName, inesatCliCode);
            this.inesatCliFilename = path_1.default.resolve(this.outDir, `${this.build.typesInesatCliName}.d.ts`);
    ...
    genCode(o) {
        ...
        if (!this.lib.key.includes(o.name)) {
            ...
            o.text = (0, transform_1.transformPathImport)(o);
    ...
    warpDeclareModule(module, code) {
        ...
        const { newModule, isExpose } = (0, transform_1.transformExposesPath)(module, this.mf);
        return {
